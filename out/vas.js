...
(function() {
  var KEYCODE_A, KEYCODE_D, KEYCODE_ENTER, KEYCODE_LEFT, KEYCODE_RIGHT, KEYCODE_SPACE, KEYCODE_UP, KEYCODE_W, baseScore, canvas, canvasHeight, canvasWidth, currentLevel, doneLoading, handleClick, handleKeyDown, handleKeyUp, init, jumpDown, leftDown, level, levelArray, levelField, messageField, player, preload, restart, rightDown, root, scoreField, stage, tick, updateLoading, watchRestart;
